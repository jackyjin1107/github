                        ...
                        wx.getStorage({
                            ...
                            success: function(res) {
                                ...
                                if (that.data.goodsClass != '') {
                                  console.log(that.data.goodsClass);
                                ...
                                query.find({
                                    success: function(results) {
                                        if (results.length > 0) {
                                            ...
                                            goods.set("costPrice",  Number(goodsForm.costPrice));
                                            goods.set("retailPrice",  Number(goodsForm.retailPrice));
                                          ...
                                          goods.set("warning_num", Number(goodsForm.warning_num));
                                            ...
                                            // goods.set("reserve", goodsForm.reserve);
                                            goods.save(null, {
